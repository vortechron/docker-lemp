...
A pretty simplified Docker Compose workflow that sets up a LEMP network of containers for local Laravel development with queue, scheduler, and websocket. You can view the full article that inspired this repo [here](https://dev.to/aschmelyun/the-beauty-of-docker-for-local-laravel-development-13c0).
...
- `docker-compose run --rm npm run dev` // or watch-poll if file changes not listen
